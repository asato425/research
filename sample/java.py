...
# モデルとエージェントの設定
"""
MODEL_NAMEには"gemini-1.5-flash"、"gemini-1.5-pro"、"gpt-4o-mini"、"gpt-5-mini"、"claude"を指定できます。
...
def main():  
    ...
    parser.add_argument(
        "--repo_url",
        type=str,
        default="https://github.com/asato425/test_java",
...
# 実行方法:
# poetry run python sample/java.py
