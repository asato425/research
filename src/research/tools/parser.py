            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    ...
                    (
                        ...
                        "注意事項:\n"
                        "- 基本的にプロジェクト内のファイルは変更せず、ymlファイルのみの修正でエラーの解決を図ってください。例えば、未インストールの依存ツールが原因でエラーが発生した場合、そのツールをインストールするのではなく、ymlファイルからそのツールを使用するステップを削除するか、他の処理で代替するようにしてください。\n"
