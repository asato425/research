            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    ...
                    (
                        ...
                        "注意事項:\n"
                        "- 基本的にプロジェクト内のファイルは変更せず、ymlファイルのみの修正でエラーの解決を図ってください。例えば、未インストールの依存ツールが原因でエラーが発生した場合、そのツールをインストールするのではなく、Lintの場合はそのジョブやステップの内容を削除し、それ以外の場合は他の処理で代替するようにしてください。\n"
